def parse_config(file_path):
    ...
    for line_number, line in enumerate(config_lines, start=1):
        ...
        if line.endswith('{'):
            section_stack.append(line.split()[0])
        elif line.endswith('}'):
    ...
    if section_stack:
        errors.append(f"Error: Incomplete section(s) at line {line_number}.")
...
if __name__ == "__main__":
    config_file = "/home/shiv/aerospike-validator/test1.conf"  # Path to Aerospike config file
